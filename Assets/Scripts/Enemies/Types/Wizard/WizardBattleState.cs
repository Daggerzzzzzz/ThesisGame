...
public class WizardBattleState : EnemyState
{
    ...
    public WizardBattleState(Enemy enemyBase, EnemyStateMachine stateMachineState, string animationNameState, EnemyWizard enemy) : base(enemyBase, stateMachineState, animationNameState)
    {
        this.enemy = enemy;
    }
